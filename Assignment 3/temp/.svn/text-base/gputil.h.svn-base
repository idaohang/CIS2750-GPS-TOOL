...
* Description: This file consists of function headers needed by gputil.c and gpstool.c to run. gputil.c includes the following library which are used by its functions. DO NOT EDIT.
	       Please see below for variable names and macros that might be needed in gputil.c or gpstool.c
********/
#ifndef GPUTIL_H_
#define GPUTIL_H_ A2
